...
if getgenv().SolarConfig then getgenv().SolarConfig = nil end
...
--[ GLOBALNE USTAWIENIA (ULTIMATE AR2) ]
getgenv().SolarConfig = {
    Visuals = {
        BoxESP = true,
        CornerBox = true,
    ...
    Combat = {
        ...
        AutoCalibration = true, -- Nowość: Automatyczne wykrywanie broni
        BulletSpeed = 2500,
        BulletGravity = 196.2
    },
    Colors = {
        Main = Color3.fromRGB(138, 43, 226), -- Fioletowy premium
...
local oldMenu = SafeGui:FindFirstChild("SolarMenu_Modular")
...
-- Obrys (Premium Border)
local UIStroke = Instance.new("UIStroke", MainFrame)
UIStroke.Thickness = 2
UIStroke.Color = Config.Colors.Main
...
-- Naprawienie rogów bocznych (żeby pasowały do reszty)
...
local function CreateTab(name)
    ...
    Frame.ScrollBarImageColor3 = Config.Colors.Main
    Frame.Visible = false
...
SelectTab("Visuals") -- Domyślna zakładka
...
CreateSlider(TabVis, "ESP Distance", "Visuals", "MaxDistance", 100, 15000, false)
...
CreateToggle(TabCbt, "Advance Physics (Drop)", "AdvancedPrediction", "Combat")
CreateToggle(TabCbt, "Auto Weapon Calibration", "AutoCalibration", "Combat") -- Nowość
CreateSlider(TabCbt, "Aim Smooth", "Combat", "Smoothness", 0.01, 1, true)
CreateSlider(TabCbt, "FOV Size", "Combat", "FOV", 10, 800, false)
CreateSlider(TabCbt, "Aim Distance", "Combat", "MaxDistance", 100, 15000, false)
CreateSlider(TabCbt, "Bullet Speed", "Combat", "BulletSpeed", 500, 5000, false)
CreateSlider(TabCbt, "Bullet Gravity", "Combat", "BulletGravity", 0, 300, true)
...
UnloadBtn.Text = "UNLOAD EVERYTHING"
...
print("[SOLARA] Moduł UI PREMIUM załadowany.")
